...
def get_creator_transcriptions(creator_name):
    ...
    Args:
        creator_name (str): Nome do criador (ex: 'alexhormozi', 'danmartell')
    ...
    try:
        ...
        return f"Arquivo {TRANSCRIPTIONS_FILE} não encontrado. Execute transcripter.py primeiro."
...
def list_available_creators():
    ...
    try:
        ...
        return f"Arquivo {TRANSCRIPTIONS_FILE} não encontrado."
    except Exception as e:
